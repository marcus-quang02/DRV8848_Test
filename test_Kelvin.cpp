...
double test_kelvin_buffer[SITE_COUNT] = {0};

double test_KELVIN_nFault(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = nFAULT.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
    ...
    return test_kelvin_buffer[SITE_1];
}

double test_KELVIN_AISEN(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = AISEN.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_nSLEEP(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = nSLEEP.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_BISEN(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = BISEN.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_AOUT1(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = AOUT1.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_AOUT2(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = AOUT2.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_BOUT1(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = BOUT1.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_BOUT2(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = BOUT2.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_AIN1(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = AIN1.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_AIN2(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = AIN2.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_BIN1(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = BIN1.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_BIN2(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = BIN2.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_VREF(int measure_interval, int samples_number, double current, int delay_time)
{
    ...
    test_kelvin_buffer[SITE_1] = VREF.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); // Lưu giá trị điện áp vào bộ nhớ đệm
...
double test_KELVIN_VINT(int measure_interval, int samples_number, double current, int delay_time)
{
    VINT.Set(FI, -5e-3, FOVI_5V, FOVI_10MA, RELAY_ON);
    delay_ms(delay_time);
    VINT.MeasureVI(measure_interval, samples_number);

    test_kelvin_buffer[SITE_1] = VINT.GetMeasResult(SITE_1, MVRET, AVERAGE_RESULT); //
